...
const PER_DISASTER = {
    ...
    'FAIL-007': { hero: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Deepwater_Horizon_offshore_drilling_unit_on_fire_2010.jpg/1280px-Deepwater_Horizon_offshore_drilling_unit_on_fire_2010.jpg', credit: 'US Coast Guard / Public Domain', alt: 'Deepwater Horizon drilling unit on fire — 2010' },
    ...
    'FAIL-012': { hero: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/22/STS-107_debris_in_hangar.jpg/1280px-STS-107_debris_in_hangar.jpg', credit: 'US Air Force / Public Domain', alt: 'Space Shuttle Columbia debris in hangar at Barksdale AFB — 2003' },
    ...
    'FAIL-014': { hero: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/View_of_damaged_Apollo_13_Service_Module_from_the_Lunar-Command_Modules_(as13-59-8500).jpg/1280px-View_of_damaged_Apollo_13_Service_Module_from_the_Lunar-Command_Modules_(as13-59-8500).jpg', credit: 'NASA / Public Domain', alt: 'Apollo 13 damaged Service Module with blown-out panel — 1970' },
    ...
    'FAIL-016': { hero: 'https://upload.wikimedia.org/wikipedia/commons/f/f9/Soyuz_11_crew.jpg', credit: 'Wikipedia / Public Domain', alt: 'Soyuz 11 crew — Dobrovolsky, Volkov, Patsayev — 1971' },
    ...
    'FAIL-020': { hero: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/06/Ponte_morandi_crollato.jpg/1280px-Ponte_morandi_crollato.jpg', credit: 'Wikipedia / CC BY-SA', alt: 'Morandi Bridge collapse — 2018 Genoa' },
    ...
    'FAIL-022': { hero: 'https://upload.wikimedia.org/wikipedia/commons/2/2d/Silver_Bridge_collapsed%2C_Ohio_side.jpg', credit: 'Federal Highway Administration / Public Domain', alt: 'Silver Bridge collapsed viewed from Ohio side — 1967' },
    ...
    'FAIL-025': { hero: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Mianus_River_Bridge_crop_of_HAER_CONN%2C5-NEWHA%2C37-3.tif/1280px-Mianus_River_Bridge_crop_of_HAER_CONN%2C5-NEWHA%2C37-3.tif.jpg', credit: 'Wikipedia / CC BY-SA', alt: 'Mianus River Bridge — 1983' },
    ...
    'FAIL-038': { hero: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Banqiao_Dam_Failure.svg/1280px-Banqiao_Dam_Failure.svg.png', credit: 'Wikipedia / CC BY-SA', alt: 'Banqiao Dam failure — 1975' },
    ...
    'FAIL-041': { hero: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/Cypress_structure.jpeg/1280px-Cypress_structure.jpeg', credit: 'Wikipedia / CC BY-SA', alt: 'Cypress Street Viaduct collapse — 1989' },
    'FAIL-042': { hero: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/Cypress_collapsed.jpg/1280px-Cypress_collapsed.jpg', credit: 'Wikipedia / CC BY-SA', alt: 'Cypress Street Viaduct — 1989' },
    'FAIL-043': { hero: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Ted_Williams_Tunnel_Boston_%280208%29.jpg/1280px-Ted_Williams_Tunnel_Boston_%280208%29.jpg', credit: 'Wikipedia / CC BY-SA', alt: 'Big Dig ceiling collapse — 2006' },
    ...
    'FAIL-046': { hero: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/View_of_damaged_Apollo_13_Service_Module_from_the_Lunar-Command_Modules_(as13-59-8500).jpg/1280px-View_of_damaged_Apollo_13_Service_Module_from_the_Lunar-Command_Modules_(as13-59-8500).jpg', credit: 'NASA / Public Domain', alt: 'Apollo 13 damaged Service Module with blown-out panel — 1970' },
