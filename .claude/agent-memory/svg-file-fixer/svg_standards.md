...
**Diagram structure**: cross-section engineering failure diagrams — ship/structure view top, 3-column detail panels middle, annotated footer bottom, interactive hotspots

**Overlap resolution priority**: labels over connectors, connectors route around shape bodies
